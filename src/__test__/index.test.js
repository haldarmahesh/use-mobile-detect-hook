...
describe('useMobileDetect', () => {
  ...
  test('should return an object of functions and vals', () => {
    ...
    expect(typeof detect.isMobile).toEqual('function');
    expect(typeof detect.isMobile()).toEqual('boolean');
    expect(typeof detect.isDesktop()).toEqual('boolean');
    expect(typeof detect.isAndroid).toEqual('function');
